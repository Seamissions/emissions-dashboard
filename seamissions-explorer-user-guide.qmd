...
When you open the app, you'll land on the Home tab, which provides a brief overview of the dashboard's purpose and quick links to it's two main tools: 1) Fishing Vessel Emissions Map 2) Compare Seafood Emissions Tool

The top navigation bar includes four tabs: 1) Home - Dashboard overview 2) Fishing Vessel Emissions Map - Explore a global map of CO₂ emissions from large-scale fishing vessels, powered by a novel dataset from Global Fishing Watch and emLab.
...
![Fishing Vessel Emissions Map Components](images/map-components.png)
...
![Compare Seafood Emissions Plot Components](images/plot-components.png)
