           ...
           fluidRow(
             column(12,
                    div(
                      ...
                      tags$img(src = "images/logos/emlab-logo-white.png", style = "width: 100%; max-width: 700px; margin-bottom: 30px;"),
                      ...
                      tags$img(src = "images/logos/gfw-logo.png", style = "width: 100%; max-width: 700px; margin-bottom: 30px;")
                    ) # END div
             )
